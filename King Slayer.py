...
class Game:
    def __init__(self):
        ...
        self.demon_passive_income_cost = 20  # Starting cost
        ...
        self.ratling_passive_income_cost = 2500  # Starting cost
        ...
        self.kobold_passive_income_cost = 15000  # Starting cost
        ...
        self.knight_passive_income_cost = 18000  # Starting cost
    ...
    def ending (self):
            ...
            screen.blit(self.ending1_msg,(100,250))
            screen.blit(self.ending2_msg,(100,270))
            screen.blit(self.ending3_msg,(100,310))
                ...
                if pygame.mouse.get_pressed()[0]:
                    ...
                    if self.clicked:
                        if self.gold >= self.goblin_passive_income_cost:
                            ...
                            self.goblin_passive_income_cost *= 1.1   #  cost for next upgrade
                ...
                if pygame.mouse.get_pressed()[0]:
                    ...
                    if self.clicked:
                        if self.gold >=self.ratling_passive_income_cost:
                            ...
                            self.ratling_passive_income_cost *= 1.1   #  cost for next upgrade
                ...
                if pygame.mouse.get_pressed()[0]:
                    ...
                    if self.clicked:
                        if self.gold >=self.kobold_passive_income_cost:
                            ...
                            self.kobold_passive_income_cost *= 1.1   #  cost for next upgrade
                ...
                if pygame.mouse.get_pressed()[0]:
                    ...
                    if self.clicked:
                        if self.gold >= self.orc_passive_income_cost:
                            ...
                            self.orc_damage_per_second+= 5     # Increase passive income by 1 gold/sec
                            self.orcs+=1
                            hire_sound.play()
                            self.clicked = False
                ...
                if pygame.mouse.get_pressed()[0]:
                    ...
                    if self.clicked:
                        if self.gold >= self.troll_passive_income_cost:
                            ...
                            self.troll_passive_income_cost *= 1.1  # Double cost for next upgrade
                            self.troll_damage_per_second+= 50     # Increase passive income by 1 gold/sec
                            self.trolls+=1
                            hire_sound.play()
                            self.clicked = False
                ...
                if pygame.mouse.get_pressed()[0]:
                    ...
                    if self.clicked:
                        if self.gold >= self.knight_passive_income_cost:
                            ...
                            self.knight_passive_income_cost *= 1.1  # Double cost for next upgrade
                            self.knight_damage_per_second+= 500    # Increase passive income by 1 gold/sec
                            self.knights+=1
                            hire_sound.play()
                            self.clicked = False
...
while run:
    ...
    if game.game_over==True and play_once==False and game.unhappy_ending==True:
            
        bad_ending_sound=pygame.mixer.Sound("assets/bad_ending.wav")
        bad_ending_sound.play()
        play_once=True

    elif game.game_over==True and play_once==False:
